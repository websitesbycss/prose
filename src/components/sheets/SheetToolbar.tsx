...
export function SheetToolbar({
  ...
  return (
    <div className="flex shrink-0 flex-wrap items-center gap-0.5 border-b border-border bg-background px-2 py-1">
      {/* Font family */}
      <select
      ...
      {/* Formula bar */}
      <span className="min-w-[2.5rem] rounded border border-border bg-muted px-1.5 py-0.5 text-center font-mono text-xs text-muted-foreground">
        {cellAddress || 'A1'}
      </span>
      <input
        className="min-w-0 flex-1 rounded border border-border bg-background px-2 py-0.5 font-mono text-xs text-foreground outline-none focus:ring-1 focus:ring-primary/60"
